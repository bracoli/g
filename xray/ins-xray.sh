...
wget -q "https://raw.githubusercontent.com/bracoli/g/main/core/xray-core.sh" && chmod +x xray-core.sh && ./xray-core.sh >/dev/null 2>&1
rm -f xray-core.sh
sleep 1
echo -e "[ ${green}INFO$NC ] Downloading & Installing Trojan-Go"
wget -q "https://raw.githubusercontent.com/bracoli/g/main/trojan/ins-trojango.sh" && chmod +x ins-trojango.sh && ./ins-trojango.sh
...
wget -q -O /usr/bin/add-grws "https://raw.githubusercontent.com/bracoli/g/main/xray/add-grws.sh" && chmod +x /usr/bin/add-grws
wget -q -O /usr/bin/add-grvl "https://raw.githubusercontent.com/bracoli/g/main/xray/add-grvl.sh" && chmod +x /usr/bin/add-grvl
wget -q -O /usr/bin/add-grtr "https://raw.githubusercontent.com/bracoli/g/main/xray/add-grtr.sh" && chmod +x /usr/bin/add-grtr
wget -q -O /usr/bin/del-grws "https://raw.githubusercontent.com/bracoli/g/main/xray/del-grws.sh" && chmod +x /usr/bin/del-grws
wget -q -O /usr/bin/del-grvl "https://raw.githubusercontent.com/bracoli/g/main/xray/del-grvl.sh" && chmod +x /usr/bin/del-grvl
wget -q -O /usr/bin/del-grtr "https://raw.githubusercontent.com/bracoli/g/main/xray/del-grtr.sh" && chmod +x /usr/bin/del-grtr
wget -q -O /usr/bin/cek-grws "https://raw.githubusercontent.com/bracoli/g/main/xray/cek-grws.sh" && chmod +x /usr/bin/cek-grws
wget -q -O /usr/bin/cek-grvl "https://raw.githubusercontent.com/bracoli/g/main/xray/cek-grvl.sh" && chmod +x /usr/bin/cek-grvl
wget -q -O /usr/bin/cek-grtr "https://raw.githubusercontent.com/bracoli/g/main/xray/cek-grtr.sh" && chmod +x /usr/bin/cek-grtr
wget -q -O /usr/bin/renew-grws "https://raw.githubusercontent.com/bracoli/g/main/xray/renew-grws.sh" && chmod +x /usr/bin/renew-grws
wget -q -O /usr/bin/renew-grvl "https://raw.githubusercontent.com/bracoli/g/main/xray/renew-grvl.sh" && chmod +x /usr/bin/renew-grvl
wget -q -O /usr/bin/renew-grtr "https://raw.githubusercontent.com/bracoli/g/main/xray/renew-ws.sh" && chmod +x /usr/bin/renew-grtr
wget -q -O /usr/bin/port-grws "https://raw.githubusercontent.com/bracoli/g/main/xray/port-grws.sh" && chmod +x /usr/bin/port-grws
wget -q -O /usr/bin/port-grvl "https://raw.githubusercontent.com/bracoli/g/main/xray/port-grvl.sh" && chmod +x /usr/bin/port-grvl
wget -q -O /usr/bin/port-grtr "https://raw.githubusercontent.com/bracoli/g/main/xray/port-grtr.sh" && chmod +x /usr/bin/port-grtr
sleep 1
